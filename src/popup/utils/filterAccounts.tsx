...
export function getFilteredAccountsData(loaderData: FilteredAccountsLoaderData, fetcherData: FilteredAccountsLoaderData | undefined): FilteredAccountsLoaderData {
